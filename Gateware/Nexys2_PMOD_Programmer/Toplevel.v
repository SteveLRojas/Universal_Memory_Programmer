...
//####### SPI Module ##########################################################
	...
	assign spi_en = (&IO_address[15:5] & ~IO_address[4] & IO_address[3] & ~IO_address[2]);	//0xFFE8 - 0xFFEB
	assign ncs = spi_select[0];
...
//####### IO Multiplexer ######################################################
	...
	assign m_from_spi = {8'h00, from_spi & {8{prev_spi_en}}};
	
	assign IO_to_cpu = m_from_keyboard | m_from_serial | m_from_timer | m_from_intcon | m_from_iomm0 | m_from_iomm1 | m_from_i2c | m_from_spi;
//#############################################################################
