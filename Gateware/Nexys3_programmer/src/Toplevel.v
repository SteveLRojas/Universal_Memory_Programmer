...
//                                              \
//****************************************************
//* Nexys3 flash memory programmer.                  *
...
// 0xFFE8 to 0xFFEB	RS-232 module	(read write)
...
//####### PLL #################################################################
	wire clk_25;
	wire clk_sys;
	PLL0 PLL_inst(.CLK_IN1(clk), .CLK_25(clk_25), .CLK_50(clk_sys));
//#############################################################################
...
//####### Serial Module #######################################################
	...
	wire uart_rx_int;
	wire uart_tx_int;
	assign serial_en = &IO_address[15:5] & ~IO_address[4] & IO_address[3] & ~IO_address[2];	//0xFFE8 - 0xFFEB
